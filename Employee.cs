    ...
    public partial class Employee : Form
    {
        ...
        private void btn_srch_employee_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                conn.Open();
                string query = @"SELECT eID as [Employee ID], eName as [Employee name], salary as Salary, 
                joiningDate as [Joining date], role as [Role],ePassword as [Employee Password] FROM Employee WHERE eName LIKE @keyword OR role LIKE @keyword";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = @"UPDATE Employee SET eName = @name, salary = @salary, joiningDate = @joiningDate, role = @role, ePassword = @password WHERE eID = @id";
        ...
        private void btn_add_employee_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(@"Data Source=LAPTOP-7FEPICVT;Initial Catalog=BSMS;Integrated Security=True;"))
            {
                ...
                string checkQuery = "SELECT COUNT(*) FROM Employee WHERE eName = @name";
                ...
                string insertQuery = @"INSERT INTO Employee (eName, salary, joiningDate, role, ePassword) 
                               VALUES (@name, @salary, @joiningDate, @role, @password)";
