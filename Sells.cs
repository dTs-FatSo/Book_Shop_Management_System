...
namespace Book_Shop_Management_System
{
    public partial class Sells : Form
    {
        ...
        private void btn_sold_books_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string query = @"
            SELECT b.bName as [Book Name], b.ISBN as ISBN , b.bPrice as Price, b.category as Category, s.saleDate as [Sale Date]
            FROM Sale s
            ...
            WHERE w.aID = @aID";
                    ...
                    da.SelectCommand.Parameters.AddWithValue("@aID", Session.CurrentAuthorID);
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        MessageBox.Show("Sorry, none of your books has been sold!");
                        dgv_sold_bks.DataSource = null;
                    }
                    else
                    {
                        dgv_sold_bks.DataSource = dt;
                    }
                }
            }
            catch (Exception ex)
        ...
        private void dgv_top_sold_bks_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
